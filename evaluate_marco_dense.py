...
from evaluate_marco import load_trec_dl, compute_mrr_at_k
...
def evaluate_msmarco_dev_dense(args, accelerator):
    ...
    if accelerator.is_local_main_process:
        logger.info(f"Loaded {dataset_name} dev with {len(corpus)} documents and {len(queries)} queries")
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="output_dense", help="Output directory")
