...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--base_model_id",
        type=str,
        default="output/paper/bi/bert-vocab-sb-tn-pmi-VT-b5-20000/final/checkpoint-150000",
    ...
    parser.add_argument(
        ...
        type=str,
        default="trec-covid",
        help="Dataset name (e.g. trec-covid)",
    )
    parser.add_argument(
        "--save_path",
        type=str,
    ...
    pre_tokenizer = Sequence(
        [WhitespaceSplit(), Split(pattern=custom_split_pattern, behavior="isolated")]
    )
